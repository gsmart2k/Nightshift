...
function settings(){const e=env as unknown as Record<string,string|undefined>;return e.AI_PROVIDER==='gemini'?{provider:'gemini',label:'Gemini',key:e.GEMINI_API_KEY,base:'https://generativelanguage.googleapis.com/v1beta/openai',model:e.GEMINI_MODEL||'gemini-3.6-flash'}:{provider:'qwen',label:'Qwen',key:e.QWEN_API_KEY,base:e.QWEN_BASE_URL,model:e.QWEN_MODEL||'qwen-plus'}}
